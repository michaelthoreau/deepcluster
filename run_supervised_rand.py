...
import subprocess
import time
unsupList = glob.glob("exp_k_1000_*/checkpoints/checkpoint_190.pth.tar")
...
for u in unsupList:
    for t in trainSetList:
        ...
        command = "python deepcluster/eval_linear.py --data_train " + t + " --data_val mnist_png/testing/ --model " + u + " --verbose --rand_weights --no_freeze"
